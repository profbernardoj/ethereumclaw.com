 ...
 * Status of an external transaction step in a wallet action.
 */
export type ExternalTransactionWalletActionStepStatus = 'preparing' | 'queued' | 'pending' | 'confirmed' | 'rejected' | 'failed';
/**
 * A description of why a wallet action (or a step within a wallet action) failed.
 */
 ...
 * Status of an SVM step in a wallet action.
 */
export type SvmWalletActionStepStatus = 'preparing' | 'queued' | 'pending' | 'confirmed' | 'finalized' | 'rejected' | 'reverted' | 'failed';
/**
 ...
 */
export type WalletActionResponse = SwapActionResponse | TransferActionResponse | EarnDepositActionResponse | EarnWithdrawActionResponse | EarnIncentiveClaimActionResponse;
/**
 * Status of a wallet action.
 */
