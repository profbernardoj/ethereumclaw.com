...
export declare class Wallets extends APIResource {
     ...
     *   await client.wallets.export('wallet_id', {
     ...
     * ```
     */
    export(walletID: string, params: WalletExportParams, options?: RequestOptions): APIPromise<WalletExportResponseBody>;
    /**
     ...
     * @example
     * ```ts
     * const rawSignResponse = await client.wallets.rawSign(
     *   'wallet_id',
     *   {
     *     params: {
     *       bytes:
     ...
     * ```
     */
    rawSign(walletID: string, params: WalletRawSignParams, options?: RequestOptions): APIPromise<RawSignResponse>;
    /**
     * Sign a message or transaction with a wallet by wallet ID.
     *
     * @example
     * ```ts
     * const walletRpcResponse = await client.wallets.rpc(
     *   'wallet_id',
     *   {
 ...
 */
export type CurveSigningChainType = 'cosmos' | 'stellar' | 'sui' | 'aptos' | 'movement' | 'tron' | 'bitcoin-segwit' | 'bitcoin-taproot' | 'pearl' | 'near' | 'ton' | 'starknet';
/**
 ...
 */
export type ExtendedChainType = 'cosmos' | 'stellar' | 'sui' | 'aptos' | 'movement' | 'tron' | 'bitcoin-segwit' | 'bitcoin-taproot' | 'pearl' | 'near' | 'ton' | 'starknet' | 'spark';
/**
...
export declare namespace UnsignedTempoTransaction {
 ...
 * The wallet chain types.
 */
export type WalletChainType = 'ethereum' | 'solana' | 'cosmos' | 'stellar' | 'sui' | 'aptos' | 'movement' | 'tron' | 'bitcoin-segwit' | 'bitcoin-taproot' | 'pearl' | 'near' | 'ton' | 'starknet' | 'spark';
/**
