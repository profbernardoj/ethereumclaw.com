...
import { Transport, Chain, SendTransactionParameters, Hash, SignMessageParameters, Hex, TypedData, SignTypedDataParameters, EIP1193Provider, PublicClient, HttpTransport } from 'viem';
import { SmartAccount, SendUserOperationParameters } from 'viem/account-abstraction';
import { SmartWalletType as SmartWalletType$1 } from '@privy-io/api-types';

type SmartWalletType = SmartWalletType$1 | 'nexus';
type Call = {
    readonly to?: any;
    readonly value?: any;
    readonly data?: any;
